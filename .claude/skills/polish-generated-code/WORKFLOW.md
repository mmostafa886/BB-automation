# polish-generated-code — Full Workflow

Full step-by-step detail for all six cleanup passes. Linked from
[SKILL.md](SKILL.md) — read that file first for the role, checklist, and execution order.
...
→ Implementation patterns (alias, assertion, action, navigation, precondition, external
integration): [SCRIPTS.md#task-4--method-implementation-patterns](SCRIPTS.md)
...
Print the summary box, filled in with real counts and detail rows.

→ Report template: [SCRIPTS.md#final-summary-report-template-step-7](SCRIPTS.md)
