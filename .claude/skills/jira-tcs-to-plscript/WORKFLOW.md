# jira-tcs-to-plscript — Full Workflow

Full step-by-step execution detail for `SKILL.md`. Read this file when actually executing the
skill; `SKILL.md` only carries the overview and the entry point.
...
→ Script template: [SCRIPTS.md#fetch-tcs-script](SCRIPTS.md#fetch-tcs-scriptjira-tc-fetch-script-used-in-workflowmd-step-3)

Write and execute the fetch script from SCRIPTS.md, replacing `<KEYS>` with the complete flat
array of TC keys in scope and `<timestamp>` with the current timestamp.
...
Cleanup (also documented in SCRIPTS.md):
```bash
...
**FILE_NOT_FOUND** → create from scratch using the template in SCRIPTS.md.
...
→ Template: [SCRIPTS.md#layer1-locator-template](SCRIPTS.md#layer1-locator-template--locator-repository-template-used-in-workflowmd-step-4-layer-1)
...
→ Template: [SCRIPTS.md#layer2-page-class-template](SCRIPTS.md#layer2-page-class-template--page-class-template-used-in-workflowmd-step-4-layer-2)
...
→ Template: [SCRIPTS.md#layer4-spec-template](SCRIPTS.md#layer4-spec-template--spec-file-template-used-in-workflowmd-step-4-layer-4)
