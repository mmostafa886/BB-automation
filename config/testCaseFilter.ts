  ...
  modules: [
    {
      ...
      testCaseIds: [3871, 3874, 3877],
    },
    {
      name: 'Navigation-Menu',
      description: 'Side navigation and menu tests',
      testCaseIds: [3899, 3903],
    },
    {
    ...
    },
    {
      ...
      testCaseIds: [4778, 4779, 4782, 4783, 4792, 4793, 4794, 4795, 4796],
    },
    {
      name: 'Reagents',
    ...
    },
    {
      ...
      testCaseIds: [4495, 4496, 4497, 4503, 4505, 4506, 4507, 4517, 4519, 4520, 5412],
    },
    {
      name: 'Users',
      description: 'User management and role permissions',
      testCaseIds: [4264, 4273],
    },
    {
      name: 'Audit-Trail',
      description: 'Audit trail and data integrity',
      testCaseIds: [4559, 4560, 4562, 4563, 4564, 5418, 5419, 5420, 5421, 5422],
    },
    {
      name: 'Instruments',
      description: 'Instrument configuration and management',
      testCaseIds: [4961, 4972, 4974, 4975, 4985, 4987, 4990, 4950, 4952, 4954, 4955, 5414, 5424],
    },
    {
      name: 'Sign-Out',
      description: 'Logout functionality',
      testCaseIds: [4257, 4259, 4260],
    },
    {
    ...
    },
    {
      ...
      testCaseIds: [6888, 6889, 6890, 6891, 6892, 6893, 6894, 6895, 6896, 6897, 6898, 6899],
    },
  ],
